...
public class OhtanisPanel extends JPanel {
	...
	public OhtanisPanel(MainFrame mainFrame) {
		...
		try {
			...
			btnNewButton_1.setBounds(88, 336, 150, 214);
			add(btnNewButton_1);
			...
			btnNewButton_2.setBounds(326, 336, 150, 214);
			add(btnNewButton_2);
			...
			btnNewButton_3.setBounds(560, 336, 150, 214);
			add(btnNewButton_3);
			...
			btnNewButton_4.setBounds(802, 336, 150, 214);
			add(btnNewButton_4);
			...
			btnNewButton_5.setBounds(1040, 336, 150, 214);
			add(btnNewButton_5);
