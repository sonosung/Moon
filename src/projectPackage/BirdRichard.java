...
public class BirdRichard extends JPanel {
	...
	public BirdRichard(MainFrame mainFrame) {
		...
		lblNewLabel_5.setBounds(468, 200, 590, 15);
		add(lblNewLabel_5);
		...
		textArea_1.setBounds(468, 347, 635, 316);
		add(textArea_1);
