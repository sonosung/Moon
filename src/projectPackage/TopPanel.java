...
public class TopPanel extends JPanel {
    ...
    public TopPanel(MainFrame mainFrame) {
        ...
        userInfoLabel.setFont(new Font("나눔고딕 ExtraBold", Font.PLAIN, 12));
        userInfoLabel.setBounds(1020, 20, 150, 25);
        ...
        btn_myPage.setBounds(1209, 62, 30, 25);
    ...
    public void displayUserInfo(UserInfoVo userId) {
        if (userId != null) {
        	userInfoLabel.setText("안녕하세요, " + userId.getUserId() + "님");
//            String userInfo = "안녕하세요, " + currentUser.getUserId() + "님";
//            userInfoLabel.setText(userInfo);
            userInfoLabel.setFont(new Font("나눔고딕", Font.PLAIN, 12));
            userInfoLabel.setForeground(Color.WHITE);
        } else {
            userInfoLabel.setText("안녕하세요");
        }
        this.setVisible(true);
    }
}
