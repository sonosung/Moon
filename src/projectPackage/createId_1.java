...
public class createId_1 extends JPanel {
	...
	public createId_1(MainFrame mainFrame) {
		...
		lblNewLabel.setBounds(530, 75, 220, 50);
		...
		agree.setBounds(812, 448, 121, 23);
		panel.add(agree);
		...
		disagree.setBounds(812, 408, 121, 23);
		panel.add(disagree);
...
//		bGroup.add(disagree);
		...
		lblNewLabel_1.setBounds(346, 163, 160, 20);
		...
		textArea.setBounds(346, 200, 587, 182);
		panel.add(textArea);
