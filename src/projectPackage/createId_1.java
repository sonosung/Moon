...
public class createId_1 extends JPanel {
	...
	public createId_1(MainFrame mainFrame) {
		...
		lblNewLabel.setBounds(530, 115, 220, 50);
		...
		agree.setBounds(770, 468, 120, 25);
		panel.add(agree);
		...
		disagree.setBounds(770, 436, 120, 25);
		panel.add(disagree);
...
//		bGroup.add(disagree);
		...
		lblNewLabel_1.setBounds(390, 210, 160, 20);
		...
		textArea.setBounds(390, 243, 500, 185);
		panel.add(textArea);
